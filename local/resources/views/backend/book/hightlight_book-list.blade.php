...
@section('main')
    <div class="row book-block">
        <form method="post">
            {{ csrf_field() }}
            <h3 class="book-block-title"><a href="#">Sách nổi bật </a><a href="{{ asset('/admin/hightlight_book/add') }}"><button type="button" class="btn btn-warning top-btn orbtn"> Thêm sách nổi bật</button></a></h3>
            <div>
